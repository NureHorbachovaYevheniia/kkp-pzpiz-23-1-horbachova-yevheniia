...
const messages = {
  uk: {
    ...
    'teacher.placeholder.example': "Приклад речення (необов'язково)",
    ...
    'student.flash.done': 'Усі картки пройдено!',
  ...
  en: {
    ...
    'teacher.placeholder.example': 'Example sentence (optional)',
    'teacher.btn.add': 'Add',
    ...
    'student.flash.done': 'All cards done!',

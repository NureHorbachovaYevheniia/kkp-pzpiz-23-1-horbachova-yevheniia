...
const messages = {
  uk: {
    ...
    'admin.stats': 'Статистика системи',
    'admin.stats.users': 'Користувачів: {n}',
    'admin.stats.students': 'Учнів: {n}',
    'admin.stats.teachers': 'Викладачів: {n}',
    'admin.stats.classes': 'Класів: {n}',
    'admin.stats.assignments': 'Завдань: {n} (активних: {active})',
    'admin.stats.tests': 'Тестів здано: {n}',
    'admin.stats.wordSets': 'Наборів слів: {n}',
    'admin.stats.wordCards': 'Карток: {n}',
    ...
    'teacher.testStartsAt': 'з {date}',
    'teacher.activateTest': 'Активувати тест',
    ...
    'stats.chart.testResults': 'Результати тестів',
    'stats.bucket.excellent': '90–100%',
    'stats.bucket.good': '70–89%',
    'stats.bucket.fair': '50–69%',
    'stats.bucket.poor': '0–49%',
    ...
    'student.assignment.flashcards': 'Вчити слова',
    'student.assignment.study': 'Перевірити слова',
    'student.assignment.review': 'Повторити складні',
    'student.assignment.test': 'Пройти тест',
    'student.assignment.testStarts': 'тест з {date}',
    'student.assignment.submitBy': 'здати до {date}',
    ...
    'api.testDatesRequired': 'Вкажіть дату початку і дедлайн тесту',
    'api.deadlineAfterStart': 'Дедлайн має бути після початку тесту',
    'api.testNotStarted': 'Тест ще не розпочався',
  },
  en: {
    ...
    'admin.stats.students': 'Students: {n}',
    'admin.stats.teachers': 'Teachers: {n}',
    'admin.stats.classes': 'Classes: {n}',
    'admin.stats.assignments': 'Assignments: {n} (active: {active})',
    'admin.stats.tests': 'Tests completed: {n}',
    'admin.stats.wordSets': 'Word sets: {n}',
    'admin.stats.wordCards': 'Cards: {n}',
    'admin.users': 'Users',
    ...
    'teacher.testStartsAt': 'from {date}',
    'teacher.activateTest': 'Activate test',
    ...
    'stats.chart.testResults': 'Test results',
    'stats.bucket.excellent': '90–100%',
    'stats.bucket.good': '70–89%',
    'stats.bucket.fair': '50–69%',
    'stats.bucket.poor': '0–49%',
    ...
    'student.assignment.flashcards': 'Learn words',
    'student.assignment.study': 'Check words',
    'student.assignment.review': 'Review mistakes',
    'student.assignment.test': 'Take test',
    'student.assignment.testStarts': 'test from {date}',
    'student.assignment.submitBy': 'submit by {date}',
    ...
    'api.testDatesRequired': 'Provide test start and deadline',
    'api.deadlineAfterStart': 'Deadline must be after test start',
    'api.testNotStarted': 'The test has not started yet',
  },
};
...
const API_ERROR_KEYS = {
  ...
  'Вкажіть дату початку і дедлайн тесту': 'api.testDatesRequired',
  'Дедлайн має бути після початку тесту': 'api.deadlineAfterStart',
  'Тест ще не розпочався': 'api.testNotStarted',
};
